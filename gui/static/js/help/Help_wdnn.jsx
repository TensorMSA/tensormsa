        ...
        return (  
            ...
            <div>
                ...
                <br />
                    ...
                    <tr>
                    <td></td>
                    <td style={{"textAlign":"center", "width":"60%"}}> <img src={this.state.url3} /> <br />
                    그림-와이드 모델 </td>
                    <td></td>
                    </tr>
                    ...
                    <tr>
                    <td></td>
                    <td style={{"textAlign":"center", "width":"60%"}}> <tr />
                    ...
                    <tr>
                    <td></td>
                    <td style={{"textAlign":"center", "width":"60%"}}> <img src={this.state.url4} /> <br />
                    그림- 딥 모델 <br /> </td>
                    <td></td>
                    </tr>
                    ...
                    <tr>
                    <td></td>
                    <td style={{"textAlign":"center", "width":"60%"}}> <img src={this.state.url5} /> <br /><br />
                    그림- 와이드 앤 딥모델 <br /> </td>
                    <td></td>
                    </tr>
                    </table>
