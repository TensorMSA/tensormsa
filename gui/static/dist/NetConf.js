...
/***/ (function(module, exports, __webpack_require__) {
	...
	const heatmap_1 = __webpack_require__(3);
	const state_1 = __webpack_require__(4);
	const dataset_1 = __webpack_require__(5);
	let mainWidth;
	...
	let nodeTypeArray = [];
	let networkType = localStorage.getItem('nn_type');
	class Player {
	    constructor() {
	        this.timerIndex = 0;
	...
	function makeGUI() {
	    ...
	    d3.select("#remove-layers").on("click", () => {
	        if (networkType === 'CNN' && state.numHiddenLayers <= 4) {
	            return;
	        }
	        state.numHiddenLayers--;
	...
	function addPlusMinusControl(x, layerIdx) {
	    ...
	    div.append("div").text(state.networkShape[i] * 10 + " neuron" + suffix);
	}
	...
	function chooseNetworkShape() {
	    if (networkType === 'CNN') {
	        ...
	        let wdnnNetwork = JSON.parse(localStorage.getItem("wdnn_config"));
	...
	function getTypeOfSelectedNode(selectedNodeId) {
