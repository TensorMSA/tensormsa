...
##############################################################################################################################
# Network Create 1 : cnn, resnet
##############################################################################################################################
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 1,"graph_seq": 1,"graph_node": "netconf_node","graph_node_name": "netconf_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 1,"graph_seq": 2,"graph_node": "netconf_data","graph_node_name": "netconf_data"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 1,"graph_seq": 3,"graph_node": "netconf_feed","graph_node_name": "netconf_feed"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 1,"graph_seq": 4,"graph_node": "eval_node","graph_node_name": "eval_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 1,"graph_seq": 5,"graph_node": "eval_data","graph_node_name": "eval_data"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 1,"graph_seq": 6,"graph_node": "eval_feed","graph_node_name": "eval_feed"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
##############################################################################################################################
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 2,"graph_seq": 1,"graph_node": "netconf_node","graph_node_name": "netconf_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 2,"graph_seq": 2,"graph_node": "netconf_data","graph_node_name": "data_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 2,"graph_seq": 3,"graph_node": "netconf_feed","graph_node_name": "pre_feed_fr2wdnn_train"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 2,"graph_seq": 4,"graph_node": "eval_node","graph_node_name": "eval_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 2,"graph_seq": 5,"graph_node": "eval_data","graph_node_name": "evaldata"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 2,"graph_seq": 6,"graph_node": "eval_feed","graph_node_name": "pre_feed_fr2wdnn_test"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 2,"graph_seq": 7,"graph_node": "netconf_data_conf","graph_node_name": "dataconf_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
##############################################################################################################################
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 3,"graph_seq": 1,"graph_node": "netconf_node","graph_node_name": "netconf_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 3,"graph_seq": 2,"graph_node": "netconf_data","graph_node_name": "data_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 3,"graph_seq": 3,"graph_node": "netconf_feed","graph_node_name": "pre_feed_keras2frame_train"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 3,"graph_seq": 4,"graph_node": "eval_node","graph_node_name": "eval_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 3,"graph_seq": 5,"graph_node": "eval_data","graph_node_name": "evaldata"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 3,"graph_seq": 6,"graph_node": "eval_feed","graph_node_name": "pre_feed_keras2frame_test"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 3,"graph_seq": 7,"graph_node": "netconf_data_conf","graph_node_name": "dataconf_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
##############################################################################################################################
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 4,"graph_seq": 1,"graph_node": "netconf_node","graph_node_name": "netconf_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 4,"graph_seq": 2,"graph_node": "netconf_data","graph_node_name": "data_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 4,"graph_seq": 3,"graph_node": "netconf_feed","graph_node_name": "pre_feed_text2wv_train"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 4,"graph_seq": 4,"graph_node": "eval_node","graph_node_name": "eval_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 4,"graph_seq": 5,"graph_node": "eval_data","graph_node_name": "test_data_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 4,"graph_seq": 6,"graph_node": "eval_feed","graph_node_name": "pre_feed_text2wv_test"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
##############################################################################################################################
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 5,"graph_seq": 1,"graph_node": "netconf_node","graph_node_name": "netconf_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 5,"graph_seq": 2,"graph_node": "netconf_data","graph_node_name": "data_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 5,"graph_seq": 3,"graph_node": "netconf_feed","graph_node_name": "pre_feed_fr2wv_test"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 5,"graph_seq": 4,"graph_node": "eval_node","graph_node_name": "eval_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 5,"graph_seq": 5,"graph_node": "eval_data","graph_node_name": "test_data_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 5,"graph_seq": 6,"graph_node": "eval_feed","graph_node_name": "pre_feed_fr2wv_test"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
##############################################################################################################################
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 6,"graph_seq": 1,"graph_node": "netconf_node","graph_node_name": "netconf_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 6,"graph_seq": 2,"graph_node": "netconf_data","graph_node_name": "data_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 6,"graph_seq": 3,"graph_node": "netconf_feed","graph_node_name": "pre_feed_text2dv_train"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 6,"graph_seq": 4,"graph_node": "eval_node","graph_node_name": "eval_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 6,"graph_seq": 5,"graph_node": "eval_data","graph_node_name": "test_data_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 6,"graph_seq": 6,"graph_node": "eval_feed","graph_node_name": "pre_feed_text2dv_test"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
##############################################################################################################################
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 7,"graph_seq": 1,"graph_node": "netconf_node","graph_node_name": "netconf_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 7,"graph_seq": 2,"graph_node": "netconf_data","graph_node_name": "data_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 7,"graph_seq": 3,"graph_node": "netconf_feed","graph_node_name": "pre_feed_train"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 7,"graph_seq": 4,"graph_node": "eval_node","graph_node_name": "eval_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 7,"graph_seq": 5,"graph_node": "eval_data","graph_node_name": "test_data_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 7,"graph_seq": 6,"graph_node": "eval_feed","graph_node_name": "pre_feed_test"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
##############################################################################################################################
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 8,"graph_seq": 1,"graph_node": "netconf_node","graph_node_name": "netconf_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 8,"graph_seq": 2,"graph_node": "netconf_data_encode","graph_node_name": "data_encode_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 8,"graph_seq": 3,"graph_node": "netconf_data_decode","graph_node_name": "data_decode_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 8,"graph_seq": 4,"graph_node": "netconf_data_merge","graph_node_name": "text_merge_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 8,"graph_seq": 5,"graph_node": "netconf_feed","graph_node_name": "feed_text2seq_train"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 8,"graph_seq": 6,"graph_node": "eval_node","graph_node_name": "eval_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 8,"graph_seq": 7,"graph_node": "eval_feed","graph_node_name": "feed_text2seq_test"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
##############################################################################################################################
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 9,"graph_seq": 1,"graph_node": "netconf_node","graph_node_name": "netconf_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 9,"graph_seq": 2,"graph_node": "netconf_data","graph_node_name": "data_csv_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 9,"graph_seq": 3,"graph_node": "netconf_feed","graph_node_name": "feed_fr2seq"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 9,"graph_seq": 4,"graph_node": "eval_node","graph_node_name": "eval_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 9,"graph_seq": 5,"graph_node": "eval_data","graph_node_name": "evaldata"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 9,"graph_seq": 6,"graph_node": "eval_feed","graph_node_name": "feed_fr2seq_test"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
##############################################################################################################################
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 10,"graph_seq": 1,"graph_node": "netconf_node","graph_node_name": "netconf_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 10,"graph_seq": 2,"graph_node": "netconf_data","graph_node_name": "datasrc"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 10,"graph_seq": 3,"graph_node": "netconf_feed","graph_node_name": "feed_img2auto_train"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
##############################################################################################################################
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 11,"graph_seq": 1,"graph_node": "netconf_node","graph_node_name": "netconf_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 11,"graph_seq": 2,"graph_node": "netconf_data","graph_node_name": "datasrc"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 11,"graph_seq": 3,"graph_node": "netconf_feed","graph_node_name": "feed_train"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 11,"graph_seq": 4,"graph_node": "eval_node","graph_node_name": "eval_node"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 11,"graph_seq": 5,"graph_node": "eval_data","graph_node_name": "evaldata"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
...
resp = requests.post('http://' + url + '/api/v1/type/wf/target/graph/',
                     json={
                        "graph_flow_info_id": 11,"graph_seq": 6,"graph_node": "eval_feed","graph_node_name": "feed_test"
                     })
data = json.loads(resp.json())
print("evaluation result : {0}".format(data))
