...
class EntityAnalyzer(ShareData):
    ...
    def __init__(self, cb_id):
        ...
        self.proper_noun = ChatKnowledgeMemDict.data.get(self.cb_id).get('proper_noun')
    ...
    def _preprocess_data(self, share_data, pos_tags):
        ...
        elif (pos_tags[1] in ['SY', 'EC', 'EP', 'VA', 'VX', 'XSV+EC', 'VX+EC', 'VX+EF', 'SF',
                              'VCP+EF', 'ETN', 'ETM', 'JKO', 'EF', 'VCP+EC', 'SSO', 'SSC', 'EP+EF']):
            return "", ""
