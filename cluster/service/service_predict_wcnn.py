from cluster.neuralnet.neuralnet_node_wcnn import NeuralNetNodeWideCnn as NeuralNetWcnn
from cluster.service.service_predict import PredictNet

class PredictNetWcnn(PredictNet):
    """
    ...
    def run(self, nn_id, parm = {}):
        ...
        if(self._valid_check(parm)) :
            return NeuralNetWcnn().predict(self._find_netconf_node_id(nn_id), parm)
