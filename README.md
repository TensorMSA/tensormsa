...
We are working on chatbot F/W based on stroy board and ontology, benefit of this ChatBot F/W is it use neural networks created on Hoyai NeuralNetwork Management system. This means you can reuse various kind of AI models like CNN,ReNet, Wdnn, Seq2Seq, Word2Vec, Doc2Vec, Autoencoder and some other networks we are working on with ChatBot F/W.   
[![HOYA ChatBot ver0.1](https://github.com/TensorMSA/TensorMSA/blob/master/chat_bot_alpha.jpg?raw=true)]
(https://youtu.be/x9bvkXJ-JeQ "HOYA ChatBot ver 0.1")
